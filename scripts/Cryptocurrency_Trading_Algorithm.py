# NOTE: This script contains the original full algorithm before the project was modularized.
...
# Retrieve two weeks of Bitcoin to USD exchange rates with a 1 day interval and save the dataframe to a variable.
